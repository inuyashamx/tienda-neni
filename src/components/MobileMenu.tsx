...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    <div className={`fixed inset-0 z-50 ${isOpen ? 'visible' : 'invisible'}`}>
      ...
      <div 
        className={`absolute left-0 top-0 w-64 h-screen bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full justify-between">
          <div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4 space-y-4">
                <a href="/pedidos" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                ...
                <a href="/productos" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/clientes" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/estadisticas" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/configuracion" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/configuracion-tienda" className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-4 border-t border-gray-200 space-y-8">
            <a href={`/tienda/${user?.email.split('@')[0]}`} target="_blank" rel="noopener noreferrer" 
               className="flex items-center text-gray-600 hover:text-[#2196f3] transition-colors duration-200">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
